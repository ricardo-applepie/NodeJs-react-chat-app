...
app.post('/api/signup', signUpMiddleWare, async (req, res) => {
    ...
    try {
        const results = await db.query('INSERT INTO users( email,username,password,age,phone__number) VALUES($1,$2,$3,$4,$5)', [email,username, password, age, phone__number]);
...
app.post('/api/messages', async (req, res) => {
    ...
    const results = await db.query('INSERT INTO messages( id,creator__id  , message__body ,created__date,recipient__id ) VALUES($1,$2,$3,$4,$5)', [id, creator__id, message__body, created__date, recipient__id  ]);
